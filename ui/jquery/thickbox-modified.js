...
function tb_show(caption, url, imageGroup) {//function called when the user clicks on a thickbox link
	...
	try {
	   ...
	   var urlString =
     /\.jpg\/;icon220$|\.jpeg\/;icon220$|\.png\/;icon220$|\.gif\/;icon220$|\.bmp\/;icon220$/;
	   var urlType = baseURL.toLowerCase().match(urlString);

		if(urlType == '.jpg/;icon220' || urlType == '.jpeg/;icon220' || urlType == '.png/;icon220' || urlType == '.gif/;icon220' || urlType == '.bmp/;icon220'){//code to show images
