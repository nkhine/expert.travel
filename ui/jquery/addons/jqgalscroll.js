	...
	$.fn.jqGalScroll = function(options){
		return this.each(function(i){
			...
			.each(function(j){
				...
				var $imageCredit = $('<div class="jqGSCredit">').appendTo(jqchild).css({opacity:el.opts.titleOpacity}).hide();
				var $imageDescription = $('<div class="jqGSDescription">').appendTo(jqchild).css({opacity:el.opts.titleOpacity}).hide();
				var image = new Image();
				image.onload = function(){
					...
					var keywords = jqimg.attr('keywords');
					if(typeof keywords != 'undefined'){
						$imageDescription.text(keywords).fadeIn();
					}
					var name = jqimg.attr('name');
					if(typeof name != 'undefined'){
						$imageDescription.text(name).fadeIn();
					}
				};
