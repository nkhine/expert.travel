	...
	************************************************************************************************************/		
	var textPadding = 8; // Padding at the left of tab text - bigger value gives you wider tabs
	...
	function showTab(parentId,tabIndex)
	{
		...
		if(activeTabIndex[parentId]>=0){
			...
			img.src = '/ui/abakuc/images/tab_right_inactive.gif';
		...
		img.src = '/ui/abakuc/images/tab_right_active.gif';
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = '/ui/abakuc/images/tab_right_over.gif';
		}
