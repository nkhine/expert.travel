...
##        top4 = top4.replace('&lt;', '<').replace('&amp;', '&')
        ...
        handler = self.get_handler('/ui/abakuc/Document_preview.xml')
    ...
    def edit_form(self, context):
        ...
        handler = self.get_handler('/ui/abakuc/trainings/Document_edit.xml')
        return stl(handler, namespace)
    ...
    def edit_image(self, context):
        ...
        handler = self.get_handler('/ui/abakuc/trainings/Document_edit_image.xml')
        return stl(handler, namespace)
